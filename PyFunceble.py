...
class Settings(object):  # pylint: disable=too-few-public-methods
    ...
    travis_autosave_final_commit = "[Results] Test of cameleon"
    # Default travis commit message
    travis_autosave_commit = "[Autosave] Test of cameleon"
    ...
    # Current directory.
    current_dir = '/home/travis/build/dead-hosts/cameleon_web_sysctl.org/'
